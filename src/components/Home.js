...
function Navbar() {
  ...
  return (
    <div className="bg-gray-100 font-sans w-full min-h-screen m-0">
      <div className="bg-gradient-to-r from-teal-900 to-teal-400 shadow fixed top-0 left-0 right-0 z-50"> {/* Changed background color */}
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="hidden sm:flex sm:items-center">
              <a href="/Home" className="text-white text-sm font-semibold hover:text-black mr-4">Home</a> {/* Changed text color */}
              <a href="/Genre" className="text-white text-sm font-semibold hover:text-black mr-4">Genre</a> {/* Changed text color */}
              <a href="/AboutUs" className="text-white text-sm font-semibold hover:text-black mr-4">About Us</a> {/* Changed text color */}
              <a href="/Contact" className="text-white text-sm font-semibold hover:text-black mr-4">Contact Us</a> {/* Changed text color */}
            </div>
