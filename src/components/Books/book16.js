...
const ProductCard = () => {
  ...
  const name = 'Harry Potter and the Goblet of Fire';
  const Baseprice = 399;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9781408855683-New.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            "Harry Potter and the Goblet of Fire" by J.K. Rowling is the fourth installment in the beloved Harry Potter series. As Harry returns to Hogwarts School of Witchcraft and Wizardry for his fourth year, he finds himself thrust into the midst of the Triwizard Tournament, a perilous competition between three wizarding schools. But when Harry's name is unexpectedly drawn from the Goblet of Fire, he must navigate deadly challenges, dark forces, and treacherous plots that threaten not only his life but the wizarding world itself. Rowling's masterful storytelling, richly imagined world, and compelling characters captivate readers of all ages, making this book a timeless classic in fantasy literature.
