...
const ProductCard = () => {
  ...
  const name = 'The Life and Adventures Of Robinson Cruisoe';
  const Baseprice = 189;

  const image = 'https://www.booksbykilo.in/media/books/BBK/9780140430073.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            "The Life and Adventures of Robinson Crusoe" by Daniel Defoe is a classic tale of survival and self-discovery. Shipwrecked on a deserted island, Robinson Crusoe must fend for himself, battling nature's challenges and his own inner demons. Through ingenuity and resilience, he builds a new life for himself, facing encounters with cannibals, pirates, and loneliness. Defoe's novel explores themes of isolation, redemption, and the indomitable human spirit, leaving a lasting impact on literature and inspiring generations of readers.
            </p>
