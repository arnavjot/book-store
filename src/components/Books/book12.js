...
const ProductCard = () => {
  ...
  const name = 'Indian Political Thought';
  const Baseprice = 135;


  const image = 'https://m.media-amazon.com/images/I/518Pg4fvOwL.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            Indian Political Thought provides a comprehensive overview of the rich and diverse tradition of political thinking in India. Authored by Aakash Singh Rathore and Ajay Verma, the book traces the evolution of Indian political thought from ancient times to the present day. It explores key concepts such as dharma, artha, and rajya, examining the contributions of thinkers like Kautilya, Buddha, Gandhi, and Ambedkar. Rathore and Verma analyze the intersections of religion, philosophy, and politics in Indian thought, offering critical perspectives on issues of governance, democracy, and social justice. With its interdisciplinary approach and rigorous scholarship, the book serves as an indispensable resource for understanding the intellectual foundations of Indian politics.
