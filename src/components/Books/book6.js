...
const ProductCard = () => {
  ...
  const name = 'The Adventure of Huckleberry Finn';
  const Baseprice = 350;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9780140620641.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            The Adventures of Huckleberry Finn" by Mark Twain follows the journey of young Huck Finn and his friend Jim, an escaped slave, as they navigate the Mississippi River aboard a raft. Along the way, they encounter a cast of colorful characters and embark on a series of misadventures that test their courage and morality. Twain's masterful storytelling weaves themes of freedom, friendship, and the moral conscience against the backdrop of pre-Civil War America, offering a powerful commentary on racism and societal norms.
            </p>
