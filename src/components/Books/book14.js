...
const ProductCard = () => {
  ...
  const name = 'The Adventure Series';
  const Baseprice = 138;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9780330316316.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            "The Adventure Series" by Enid Blyton is a classic children's adventure series comprising eight thrilling novels. Set in picturesque locations such as castles, islands, and hidden valleys, each book follows the exciting escapades of a group of siblings—Philip, Dinah, Lucy-Ann, and Jack—and their parrot, Kiki. From solving mysteries and uncovering ancient secrets to outwitting villains and exploring uncharted territories, the children embark on unforgettable journeys filled with danger and excitement. Blyton's masterful storytelling and vivid descriptions transport readers into a world of endless adventure, where bravery, friendship, and curiosity reign supreme.
