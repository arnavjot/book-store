...
const ProductCard = () => {
  ...
  const name = 'Mr Gum And cherry Tree';
  const Baseprice = 125;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9781405293754-New.jpg';
...
"Mr Gum and the Cherry Tree" by Andy Stanton is a whimsical and hilarious children's book that follows the misadventures of the infamous Mr. Gum in the town of Lamonic Bibber. When Mr. Gum's dastardly schemes threaten the beloved cherry tree of Polly, the plucky heroine, it's up to her and her friends, including the eccentric Friday O'Leary and the lovable Jake the Dog, to save the day. Packed with quirky characters, absurd humor, and imaginative storytelling, this book is sure to captivate young readers with its zany charm and witty dialogue.
