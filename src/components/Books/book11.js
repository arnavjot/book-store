...
const ProductCard = () => {
  ...
  const name = 'Real Donlad Trump';
  const Baseprice = 250;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9781510729834-New.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            "The Real Donald Trump" offers an in-depth examination of one of the most polarizing figures in contemporary American politics. Authored by Michael D'Antonio, this biography provides a comprehensive portrait of Donald Trump, from his upbringing in Queens to his ascent to the presidency. D'Antonio explores Trump's business ventures, his foray into reality television, and his tumultuous presidency, offering insights into his personality, motivations, and leadership style. Drawing on interviews, archival material, and firsthand accounts, the book seeks to uncover the man behind the media persona, providing readers with a nuanced understanding of Trump's life and career.
