...
const ProductCard = () => {
  ...
  const name = 'The Mystery Of Burnt Cottage';
  const Baseprice = 225;


  const image = 'https://www.booksbykilo.in/media/books/BBK/9780603564338-New.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            The Mystery of the Burnt Cottage" by Enid Blyton is the first installment in the timeless "Five Find-Outers" series. When a mysterious fire breaks out in a cottage, the Five Find-Outers—Larry, Daisy, Pip, Bets, and Fatty—set out to solve the puzzling case. With clever deductions, hidden clues, and plenty of sleuthing, the intrepid young detectives unravel a web of secrets and uncover the truth behind the burnt cottage. Blyton's engaging narrative and captivating plot twists make this book a thrilling read for children, inviting them to join the Five Find-Outers on their exciting adventures and mysteries.
