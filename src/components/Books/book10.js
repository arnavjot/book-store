...
const ProductCard = () => {
  ...
  const name = 'Technofeudalism: What Killed Capitalism?';
  const Baseprice = 178;


  const image = 'https://m.media-amazon.com/images/I/71s0nMt3h7L._AC_UL480_QL65_.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            Technofeudalism: What Killed Capitalism? by Vivek Wadhwa and Alex Salkever presents a compelling exploration of the evolving dynamics between technology, capitalism, and society. The authors argue that the unchecked growth of technology giants has led to the emergence of a new form of feudalism, where power and wealth are concentrated in the hands of a few tech oligarchs. Wadhwa and Salkever delve into the ramifications of this shift, discussing its impact on democracy, innovation, and economic inequality. With insightful analysis and thought-provoking arguments, the book offers a timely examination of the challenges posed by technofeudalism and explores potential pathways forward.
