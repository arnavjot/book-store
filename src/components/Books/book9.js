...
const ProductCard = () => {
  ...
  const name = 'Savrkar:Echoes From Forgotten Past';
  const Baseprice = 480;


  const image = 'https://m.media-amazon.com/images/I/812ao-DsKzL._SL1500_.jpg';
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            "Savarkar: Echoes from a Forgotten Past" delves into the life and times of Vinayak Damodar Savarkar, a controversial figure in India's history. Authored by Vikram Sampath, the book meticulously uncovers the lesser-known facets of Savarkar's journey, from his early years as a freedom fighter to his ideological contributions. Sampath's narrative navigates through Savarkar's political activism, his vision of Hindutva, and his complex relationship with the Indian independence movement. Through extensive research and analysis, the book sheds light on Savarkar's legacy, inviting readers to reconsider his place in India's socio-political landscape.
